...
class AdaptiveGroupNorm(nn.Module):
    def __init__(self, num_groups,in_channel, style_dim):
        ...
        # print("style:",style_dim)  # 64
        # print("in_channel:", in_channel)
        #
        # self.style = dense(style_dim, in_channel)
        # # print("style_dim:",style_dim)  # 256
        # # print("in_channel:", in_channel)  # 64
        # inp1 = style_dim
        # mip1 = in_channel
        # inp2 = in_channel*2
        # mip2 = in_channel
        # self.conv2 = nn.Conv2d(inp1, mip1, kernel_size=1, stride=1, padding=0)
        # self.conv1 = nn.Conv2d(inp2, mip2, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, input, style):
        out = self.norm(input)
        # 这里的style是z的维度，然后将z的维度进行扩展到四维
        # print("style1:", style.shape)   # z二维style1: torch.Size([4, 256])
        # print("style2:", style.shape)   # z二维style2: torch.Size([4, 128, 1, 1])
        # print("gamma:",gamma.shape)   # gamma: torch.Size([4, 64, 1, 1])
        # print("out:", out.shape)   # out: torch.Size([4, 64, 256, 256])
        # print("beta:", beta.shape)  # beta: torch.Size([4, 64, 1, 1])
        # print("input:", input.shape)
        # style = self.conv2(style)
        # print("style2:", style.shape)
        # out1 = torch.cat((input, style), dim=1)
