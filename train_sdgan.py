...
def sample_from_model(coefficients, generator, n_time, x_init, T, opt):
    x = x_init
    with torch.no_grad():
        for i in reversed(range(n_time)):  # 采样步数
   ...
   # print("path:", exp_path)
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        if rank == 0:
            ...
            torchvision.utils.save_image(x_t_1,
                                         os.path.join(exp_path, 'x_t_1_discrete_epoch_{}.png'.format(epoch)),
                                         normalize=True)
...
def init_processes(rank, size, fn, args):
    ...
    os.environ['MASTER_PORT'] = '23000'#'6020'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='sun', help='name of dataset')
